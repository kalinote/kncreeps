...
export abstract class BasePlanner {
  protected service: ConstructPlannerLayoutService;

  constructor(service: ConstructPlannerLayoutService) {
   ...
   */
  public abstract plan(room: Room, context: PlanningContextMemory): BuildingPlanMemory[];
}
